...
- **关键流程点**：
  ...
  2. DisplayProcesses中ReplacePlaceholders替换{1}→**\_**（需保留\*\*）
...
- **可能的问题**：
  ...
  - MergePlaceholdersWithValues替换**\_**时，没有保留\*\*标记
...
| ReplacePlaceholders         | 逐字符扫描{...}替换**\_**，其他原样   | ✓ \*\*不在{}中 | ✓    |
| MergePlaceholdersWithValues | 逐字符扫描**\_**替换用户值，其他原样  | ✓ \*\*不是\_   | ✓    |
